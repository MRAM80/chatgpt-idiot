...
export default function DriversPage() {
  ...
  return (
    <AppShell
      title="Drivers & Fleet"
      subtitle="Drivers, truck alignment, and dispatch readiness"
      actions={
        <>
          <button
            onClick={refreshAll}
          ...
          <button
            ...
            className="rounded-lg px-3 py-2 text-sm font-medium text-slate-600 ring-1 ring-slate-200 transition hover:bg-slate-50 hover:text-slate-900"
          >
            New Truck
          </button>
          <button
    ...
    >
      <>
          ...
          <div className="mb-6 grid grid-cols-2 gap-px overflow-hidden rounded-xl bg-slate-200 ring-1 ring-slate-200 dark:bg-slate-700 lg:grid-cols-6">
            {[
              { label: 'Total Drivers', value: dashboardCounts.totalDrivers, tone: 'text-slate-900' },
              { label: 'Available', value: dashboardCounts.availableDrivers, tone: 'text-emerald-600' },
              { label: 'Busy', value: dashboardCounts.busyDrivers, tone: 'text-amber-600' },
              { label: 'Linked Logins', value: dashboardCounts.linkedDrivers, tone: 'text-slate-900' },
              { label: 'Total Trucks', value: dashboardCounts.totalTrucks, tone: 'text-slate-900' },
              { label: 'Available Trucks', value: dashboardCounts.availableTrucks, tone: 'text-slate-900' },
            ].map(k => (
